...
const services = [
  {
    icon: <CogIcon className='w-12 h-12 text-accentlp' />,
  ...
  {
    icon: <WrenchScrewdriverIcon className='w-12 h-12 text-accentlp' />,
  ...
  {
    icon: <CubeTransparentIcon className='w-12 h-12 text-accentlp' />,
...
export default function Services() {
  return (
    <section className='bg-secondarylp py-20' id='services'>
      <div className='container mx-auto px-6 md:px-12 text-center'>
        <motion.h2
          initial={{ opacity: 0, y: -20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className='text-3xl md:text-4xl font-bold text-primarylp'
        >
          Layanan Kami
        </motion.h2>
        <motion.p
          ...
          className='mt-4 text-primarylp/80 max-w-2xl mx-auto'
        >
        ...
        <div className='mt-12 grid gap-8 md:grid-cols-3'>
          {services.map((service, i) => (
            ...
            >
              ...
              <h3 className='text-xl font-semibold text-primarylp'>
                {service.title}
              </h3>
              <p className='mt-4 text-primarylp/70'>{service.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
